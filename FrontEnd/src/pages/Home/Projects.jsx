  ...
  return (
    <div className="sm:h-[60vh] pt-6 sm:pt-0 max-h-[500px] min-h-[400px] md:pb-[-10px] gap-8 w-full flex flex-col ">
      ...
      <div className="flex flex-col w-full md:gap-36 items-center  md:flex-row mt-2 h-full gap-2">
        ...
        {/* Project details */}
        <div className="rightExp flex-1 h-fit bg-gradient-to-r  from-secondary-secondary-2/20 to-primary-dark-bg-1 border-gradient-to-r to-secondary-secondary- border shadow-md shadow-secondary-secondary-2 border-secondary-secondary-2 pb-8 bg-gray-800 p-3 max-w-[900px] rounded-md shadow-lg">
          {ProjectsData.map((data, index) => (
